...
export default function Navbar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex flex-col pointer-events-none">
      ...
      <nav className="bg-black/95 backdrop-blur-lg border-t border-white/10 pointer-events-auto">
      ...
      {/* 2. Footer Legal Final debajo del Menú [cite: 2025-12-23] */}
      <div className="bg-black py-1.5 px-6 border-t border-white/5 pb-safe pointer-events-auto">
        <div className="max-w-md mx-auto flex justify-between items-center text-[7px] text-zinc-500 uppercase font-black tracking-[0.2em]">
