...
export default function ViberHeader({ onLogout }: { onLogout: () => void }) {
  const { user } = useAuth();
  return (
    <div className="flex justify-between items-start mb-8 pr-2">
      <div className="flex-1">
        <h2 className="text-[10px] font-black tracking-[0.3em] uppercase text-zinc-500 mb-1 leading-none">NITVIBES</h2>
        <h1 className="text-3xl font-black italic tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 leading-[1.1] pb-1">
          PANEL VIBER
        </h1>
