...
import Link from "next/navigation"; // Cambiado a next/link en el renderizado final para evitar errores
          ...
          return (
            <NextLink
              ...
              className={`flex flex-col items-center gap-1.5 transition-all ${
                isActive ? "text-pink-500 scale-110" : "text-zinc-600 hover:text-white"
              }`}
            >
